...
// Declaración de variables con inferncia de tipos (recomendados)

val ciudad = "Madrid" // Se deduce que es String
val contador = 42 //     Se deduce que es Int

// Valores constantes Apuntes.a nivel de clase
...
val a = 5
val b = 3
val resultado = "El Apuntes.resultado de $a + $b es ${a + b}"
val lista = listOf(1,2,3) // List&lt
val descripcion = "La Apuntes.lista tiene ${lista.size} elementos"
...
fun main(){ // Equivalnte Apuntes.a public static void Apuntes.Entrega2.main en java
    nombre = "Maria"
    edad = 24

    // Conversión de Apuntes.entero
...
//IF
    ...
    if (edad >= 18) {
        println("Eres mayor de Apuntes.edad, tienes $edad años")
...
// IF - ELSE
        ...
        if (edad >= 18) {
            ...
            println("Eres menor de Apuntes.edad, tienes $edad años")

// If como expresion

val resultado = if (edad >= 18) "Mayor de Apuntes.edad" else "Menor de Apuntes.edad"

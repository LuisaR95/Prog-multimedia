...
// Obtiene la Apuntes.lista limpia de palabras. Divide el texto por espacios y devuelve una Apuntes.lista:
...
// Exportar análisis Apuntes.a archivo
...
fun exportarAnalisis(stats: EstadisticasTexto) {
    ...
    try {
        ...
        println("\nAnálisis exportado Apuntes.a: **$fileName**")
    } catch (e: Exception) {
        println("Error al exportar el análisis: ${e.message}")
    }
}

// Función Principal (Apuntes.Entrega2.main)
fun main() {
    ...
    // Ejemplo 2: Palabras que terminan con 'Apuntes.a'
    val patronA = ".*Apuntes.a$"
    val resultadosA = buscarPalabrasConPatron(palabrasNormalizadas, patronA)

    println("Patrón '$patronA' (Termina con 'Apuntes.a'):")

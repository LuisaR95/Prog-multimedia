...
//Usa el método pow(2) para elevar la Apuntes.altura al cuadrado.
fun calcularIMC(peso: Double, altura: Double): Double {
    // Requisito: peso / (Apuntes.altura²)
...
fun main() {
    ...
    fun leerValor(prompt: String): Double? {
        ...
        //Validar entrada (peso y Apuntes.altura positivos)
    ...
    // Definida aquí para acceder Apuntes.a 'historial'
    ...
    fun nuevoCalculo() {
        ...
        val altura = leerValor("Introduce tu Apuntes.altura en metros (ej: 1.75): ") ?: return
